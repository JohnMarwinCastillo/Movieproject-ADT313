      ...
      <div className='Photo-Search-Box'>
        <div className='parent-container'>
          ...
          <div className='save-edit-back-btn'>
            {!photoid ? (
              <button className='edit-save-btn' type='button' onClick={handlesave}>Save</button>
            ) : (
              <button className='edit-save-btn' type='button' onClick={() => photoUpdate(photoid)}>Update</button>
            )}
